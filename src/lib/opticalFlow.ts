...
export async function processSmoothSlowMoBrowser(
  ...
  try {
    ...
    return {
      ...
      colorConversionTimeMs: decodeResult.colorConversionTimeMs,
      ...
      colorConversionPct: decodeResult.colorConversionPct,
      ...
      colorConversionMsPerFrame: decodeResult.colorConversionMsPerFrame,
      encoderMsPerFrame: decodeResult.encoderMsPerFrame,
      matAllocations: decodeResult.matAllocations,
      byteBufferAllocations: decodeResult.byteBufferAllocations,
      frameCopies: decodeResult.frameCopies,
    };
