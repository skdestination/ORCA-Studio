...
class FontManager private constructor(val context: Context) {
    ...
    companion object {
        ...
        fun getInstance(): FontManager {
            return instance ?: throw IllegalStateException("FontManager has not been initialized with Context.")
        }
    }
