...
object TimelineTheme {
    ...
    // Borders
    var clipBorderColorVideo: Int = 0x336366F1.toInt()
    var clipBorderColorAudio: Int = 0x33A855F7.toInt()
    var clipBorderColorText: Int = 0x33F59E0B.toInt()
    var clipBorderColorImage: Int = 0x3310B981.toInt()
